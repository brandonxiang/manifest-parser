    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    body = _a.sent();
                    re = /<link\s+rel=[\"']manifest[\"'].*?href=[\"']([\S\s]*?)[\"'].*?[\/]?>/i;
...
function readManifest(url, path) {
    return __awaiter(this, void 0, void 0, function () {
        var manifestUrl, res, bodyStr, body, manifestJson;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function parseManifest(url) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getManifest(url)];
                case 1:
                    path = _a.sent();
                    return [4 /*yield*/, readManifest(url, path)];
                case 2:
                    output = _a.sent();
